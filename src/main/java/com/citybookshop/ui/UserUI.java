...
public class UserUI extends Application {
    ...
    public UserUI(String user, String pass) {
    ...
    public void start(Stage stage) {
        ...
        welcomeLabel.setStyle("-fx-font-size: 18px; -fx-text-fill: white; -fx-font-weight: bold; -fx-alignment: center; -fx-padding: 10px;-fx-max-width: 200px; -fx-letter-spacing: 10px;");
        ...
        VBox sidebar = new VBox(20, welcomeLabel, viewBooks, profile);
        ...
        label.setStyle("-fx-font-size: 50px; -fx-text-fill: white; -fx-font-weight: bold; -fx-alignment: center; -fx-wrap-text: true;-fx-text-alignment: center; -fx-padding: 20px; -fx-letter-spacing: 3px;");
