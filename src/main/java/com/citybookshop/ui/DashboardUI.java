...
public class DashboardUI extends Application {
    ...
    public void start(Stage stage) {
        ...
        label.setStyle("-fx-font-size: 25px; -fx-text-fill: white; -fx-font-weight: bold; -fx-alignment: center; -fx-wrap-text: true;-fx-text-alignment: center; -fx-padding: 20px;");
